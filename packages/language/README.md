...
- [src/e-lang.langium](src/e-lang.langium) -  The grammar definition of your language
- [src/e-lang-module.ts](src/e-lang-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/e-lang-validator.ts](src/e-lang-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/e-lang.monarch.ts](src/syntaxes/e-lang.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/e-lang.tmLanguage.json](syntaxes/e-lang.tmLanguage.json) - Textmate based syntax highlighting instructions.
